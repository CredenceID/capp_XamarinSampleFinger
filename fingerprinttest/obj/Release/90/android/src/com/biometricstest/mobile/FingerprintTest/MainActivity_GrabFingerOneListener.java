...
public class MainActivity_GrabFingerOneListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FingerprintTest.MainActivity+GrabFingerOneListener, SampleFingerprint", MainActivity_GrabFingerOneListener.class, __md_methods);
	}


	public MainActivity_GrabFingerOneListener ()
	{
		super ();
		if (getClass () == MainActivity_GrabFingerOneListener.class)
			mono.android.TypeManager.Activate ("FingerprintTest.MainActivity+GrabFingerOneListener, SampleFingerprint", "", this, new java.lang.Object[] {  });
	}
